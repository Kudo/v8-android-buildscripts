...
if [[ ${PLATFORM} = "android" ]]; then
  ...
  sudo apt-get -y install libgcc-10-dev-armhf-cross libc6-dev libc6-dev-armel-cross libc6-dev-armhf-cross libc6-dev-arm64-cross libc6-dev-i386 libc6-dev-armel-armhf-cross libstdc++-10-dev-armhf-cross libstdc++-9-dev-armhf-cross
